...
public class ActivityAIService {
    ...
    private Recommendation processAiResponse(Activity activity, String aiResponse){
        try{
            ...
            JsonNode fullJsonContent = mapper.readTree(jsonContent);
            JsonNode analysisNode = fullJsonContent.path("analysis");
            ...
            List<String> improvements = extractImprovements(fullJsonContent.path("improvements"));

            List<String> suggestions = extractSuggestions(fullJsonContent.path("suggestions"));

            List<String> safety = extractSafetyGuidelines(fullJsonContent.path("safety"));
